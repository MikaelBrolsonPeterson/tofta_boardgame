...
export const TERRAIN: Record<TerrainType, TerrainConfig> = {
  ...
  plains:    { label: 'Plains',    color: '#7a8a18', highlight: '#b0c828', textColor: '#f0f4a0', goldProduction: 2,  defenseBonus: 0,  attackBonus: 0, attacksToConquer: 1, conquerable: true  },
  farmland:  { label: 'Farmland',  color: '#2d5c1a', highlight: '#449a28', textColor: '#b0f0a0', goldProduction: 0,  defenseBonus: 0,  attackBonus: 0, attacksToConquer: 1, conquerable: true  },
